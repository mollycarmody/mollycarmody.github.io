(() => {
  ...
  var rotateLKeyPressed= false;  
  var rotateRKeyPressed= false;  
  ...
  const keyHandler = e => {
    ...
    if (e.code === "KeyW") {
      ...
      rotateLKeyPressed = keyPressed;
        cameraRotationY += e.movementX / 150;
    } else if (e.code === "KeyM") {
      rotateRKeyPressed = keyPressed;
...
//    document.removeEventListener("mousemove", mouseHandler);
    ...
    rotateLKeyPressed= false;  
    rotateRKeyPressed= false;  
  };
